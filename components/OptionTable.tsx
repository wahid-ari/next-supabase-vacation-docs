...
export function OptionTable({ options }: { options: any }) {
  return (
    <div className='mb-4 mt-6 overflow-x-auto overscroll-x-contain pb-4'>
      ...
      <table className='w-full border-collapse text-sm'>
        ...
        <tbody className='align-baseline text-gray-900 dark:text-gray-100'>
          {options.map(([method, description]) => (
            <tr key={method} className='border-b border-gray-100 dark:border-neutral-700/50'>
              <td
                className={cn(
                  'whitespace-pre py-2 align-middle font-mono font-semibold leading-6',
