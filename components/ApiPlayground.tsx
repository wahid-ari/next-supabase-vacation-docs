...
function MethodBadge(method: string) {
  ...
  return <div className={`rounded-lg px-1.5 font-medium ${color}`}>{method}</div>;
}
    ...
    <div className='mt-8 rounded-md border p-4 dark:border-neutral-800'>
      ...
      {param ? (
        <div className='-mb-2 mt-6'>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            <p className='m-0 font-medium text-neutral-700 dark:text-neutral-200'>{paramName}</p>
            <input
      ...
      >
        {loading ? (
          ...
          <svg className='h-3 fill-white' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 384 512'>
