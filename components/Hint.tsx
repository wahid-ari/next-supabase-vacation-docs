...
export default function Hint({ className, children }: { className?: string; children: ReactNode }) {
  return (
    <div
...
Hint.success = ({ className, children }: { className?: string; children: ReactNode }) => {
  return (
    <div
...
Hint.warning = ({ className, children }: { className?: string; children: ReactNode }) => {
  return (
    <div
...
Hint.danger = ({ className, children }: { className?: string; children: ReactNode }) => {
  return (
    <div
